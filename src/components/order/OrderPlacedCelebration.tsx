...
export function OrderPlacedCelebration({
  ...
  const dialogRef = useDialog<HTMLDivElement>(true, onDismiss)
  ...
  return (
    <div className="fixed inset-0 z-[60] grid animate-fade-in place-items-center bg-ink/40 p-6 backdrop-blur-sm">
      <div
        ...
        aria-describedby="order-placed-message"
        className="flex w-full max-w-sm animate-pop-in flex-col items-center rounded-3xl bg-white p-8 text-center shadow-pop"
      >
        ...
        <h2 id="order-placed-title" className="text-2xl font-bold text-ink">
          Order placed
        </h2>
        <p id="order-placed-message" className="mt-1 text-body text-ink-muted">
          {message}
        </p>
