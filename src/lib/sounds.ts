...
// Customer: a warm, friendly two-note chime for order updates.
export function playCustomerAlert() {
  play([
    { from: 783.99, to: 783.99, duration: 0.16, type: 'triangle', gain: 0.13 },
    { from: 1046.5, to: 1046.5, duration: 0.32, type: 'triangle', gain: 0.12, at: 0.13 },
  ])
}

// Admin: an urgent, attention-grabbing bell burst for incoming orders,
// bright enough to be noticed across the room like a POS / kitchen bell.
export function playAdminAlert() {
  strikeBell(0, 1046.5, 0.62)
  strikeBell(0.16, 1046.5, 0.62)
  strikeBell(0.4, 1318.51, 0.68)
}
